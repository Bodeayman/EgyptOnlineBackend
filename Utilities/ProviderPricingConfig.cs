namespace EgyptOnline.Utilities
{
    ...
    public static class ProviderPricingConfig
    {
        ...
        public const decimal SCULPTOR_SUBSCRIPTION_COST = 50m;
        ...
        public const int SCULPTOR_SUBSCRIPTION_POINTS = 25;
        ...
        public const int SCULPTOR_REGISTRATION_POINTS = 25;
        ...
        public static decimal GetSubscriptionCost(string providerType)
        {
            return providerType?.ToLower() switch
            {
                ...
                "sculptor" => SCULPTOR_SUBSCRIPTION_COST,
        ...
        public static int GetSubscriptionPoints(string providerType)
        {
            return providerType?.ToLower() switch
            {
                ...
                "sculptor" => SCULPTOR_SUBSCRIPTION_POINTS,
        ...
        public static int GetRegistrationPoints(string providerType)
        {
            return providerType?.ToLower() switch
            {
                ...
                "sculptor" => SCULPTOR_REGISTRATION_POINTS,
