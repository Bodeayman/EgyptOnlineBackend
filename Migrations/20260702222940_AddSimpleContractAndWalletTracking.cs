...
namespace EgyptOnline.Migrations
{
    ...
    public partial class AddSimpleContractAndWalletTracking : Migration
    {
        ...
        {
            // Add SourceWalletNumber if it doesn't exist
            ...
            // Add WalletNumber if it doesn't exist
            migrationBuilder.Sql(@"
                DO $$ 
                BEGIN 
                    IF NOT EXISTS(SELECT 1 FROM information_schema.columns 
            ...
            // Add RecipientPhoneNumber if it doesn't exist
            migrationBuilder.Sql(@"
                DO $$ 
                BEGIN 
                    IF NOT EXISTS(SELECT 1 FROM information_schema.columns 
            ...
            // Add WalletOwnerName if it doesn't exist
            migrationBuilder.Sql(@"
                DO $$ 
                BEGIN 
                    IF NOT EXISTS(SELECT 1 FROM information_schema.columns 
            ...
            // Contract table columns - using conditional checks
            migrationBuilder.Sql(@"
                DO $$ 
                BEGIN 
                    IF NOT EXISTS(SELECT 1 FROM information_schema.columns 
            ...
            // Add CheckInTime to AttendanceRecords if it doesn't exist
            migrationBuilder.Sql(@"
                DO $$ 
                BEGIN 
                    IF NOT EXISTS(SELECT 1 FROM information_schema.columns 
            ...
            migrationBuilder.Sql(@"
                ...
                BEGIN 
                    IF NOT EXISTS(SELECT 1 FROM information_schema.tables 
                        ...
                        AND indexname='IX_Contracts_ClientUserId') 
                    THEN 
